...
namespace EnginX.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "AddressID,CityID,UserID,HouseNumber,StreetName")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "AddressID,CityID,UserID,HouseNumber,StreetName")] Address address)
        {
            if (ModelState.IsValid)
            {
